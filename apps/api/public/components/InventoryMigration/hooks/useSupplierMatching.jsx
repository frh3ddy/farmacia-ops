// Custom hook for supplier matching logic
const { useState, useEffect } = React;

const useSupplierMatching = (allSuppliers, supplierNameMappings, setEditedResults, setSupplierNameMappings, setOpenAutocomplete) => {
